...
public class CompensationController {
    ...
    public ResponseEntity<CommonResponse> createEmployeeCompensationStructure(
        ...
        compensationStructureService.createEmployeeCompensationStructure(compensationStructureDTO);
        
        return ResponseEntity.status(OK)
                .body(new CommonResponse(OK.value(), "Compensation info inserted success", null));
    }
    ...
    public ResponseEntity<CommonResponse> getEmployeeCompensationStructureByEmployeeIdOrCompensationId(
        ...
        return ResponseEntity.status(OK)
                .body(new CommonResponse(OK.value(), "Compensation info retrieve success.",
                        compensationStructureService
    ...
    public ResponseEntity<CommonResponse> updateEmployeeCompensationStructureById(
        ...
        compensationStructureService.updateEmployeeCompensationStructureById(compensationId, compensationStructureDTO);

        return ResponseEntity.status(OK)
                .body(new CommonResponse(OK.value(), "Compensation info updated success", null));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<CommonResponse> deleteEmployeeCompensationStructureById(
            @PathVariable("id") Long compensationId) {
        compensationStructureService.deleteEmployeeCompensationStructureById(compensationId);

        return ResponseEntity.status(OK)
                .body(new CommonResponse(OK.value(), "Compensation info delete success.", null));
    }
}
